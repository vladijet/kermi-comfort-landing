      ...
      <div class="type-selector" id="tsec_FK0" style="display:block;">
        ...
        <div class="type-panels">
          <div class="type-info-row" id="row_FK0_10" style="display:none;">
            <div class="type-depth-badge"><span class="type-lbl">тип</span><div class="type-num">10</div><span class="type-lbl">глубина</span><div class="type-depth">48,5 мм</div><div class="type-desc-small">1 греющая панель без конвективного оребрения</div></div>
          ...
          <div class="type-info-row" id="row_FK0_11" style="display:none;">
            <div class="type-depth-badge"><span class="type-lbl">тип</span><div class="type-num">11</div><span class="type-lbl">глубина</span><div class="type-depth">65 мм</div><div class="type-desc-small">1 греющая панель + 1 конвективное оребрение</div></div>
          ...
          <div class="type-info-row" id="row_FK0_12" style="display:none;">
            <div class="type-depth-badge"><span class="type-lbl">тип</span><div class="type-num">12</div><span class="type-lbl">глубина</span><div class="type-depth">68 мм</div><div class="type-desc-small">2 греющие панели + 1 конвективное оребрение</div></div>
          ...
          <div class="type-info-row" id="row_FK0_20" style="display:none;">
            <div class="type-depth-badge"><span class="type-lbl">тип</span><div class="type-num">20</div><span class="type-lbl">глубина</span><div class="type-depth">102 мм</div><div class="type-desc-small">2 греющие панели без конвективного оребрения</div></div>
          ...
          <div class="type-info-row" id="row_FK0_22" style="display:none;">
            <div class="type-depth-badge"><span class="type-lbl">тип</span><div class="type-num">22</div><span class="type-lbl">глубина</span><div class="type-depth">102 мм</div><div class="type-desc-small">2 греющие панели + 2 конвективных оребрения</div></div>
          ...
          <div class="type-info-row" id="row_FK0_30" style="display:none;">
            <div class="type-depth-badge"><span class="type-lbl">тип</span><div class="type-num">30</div><span class="type-lbl">глубина</span><div class="type-depth">157 мм</div><div class="type-desc-small">3 греющие панели без конвективного оребрения</div></div>
          ...
          <div class="type-info-row" id="row_FK0_33" style="display:none;">
            <div class="type-depth-badge"><span class="type-lbl">тип</span><div class="type-num">33</div><span class="type-lbl">глубина</span><div class="type-depth">157 мм</div><div class="type-desc-small">3 греющие панели + 3 конвективных оребрения</div></div>
      ...
      <div class="feature-list">
        <div class="feature-item">
          ...
          <div>
            ...
            <div class="feature-text">Холоднокатаная сталь с повышенной коррозионной стойкостью, толщиной 1,2 мм. производства «Северсталь». Ресурс в 1,5 раза выше, чем у обычной стали.</div>
          </div>
        </div>
        <div class="feature-item">
...
<section class="selection" id="selection" style="position:relative;z-index:2">
  ...
  <div class="container">
    <div id="kermi-widget-cafdc5eb" style="max-width:1200px;margin:0 auto;">
    ...
    <div class="ral-grid">
      <div>
        ...
        <div style="margin-top:24px;font-size:13px;">
          ...
          <code style="display:block;padding:8px 12px;margin:6px 0;font-size:13px;">FTV22050040<span style="background:#BFDE05;border-radius:3px;padding:0 2px;font-weight:700">1</span>R2C<span style="background:#BFDE05;border-radius:3px;padding:0 2px;font-weight:700">RAL7022</span></code>
          <span style="color:var(--grey)">Глянцевый (код «1») + суффикс RAL</span>
          <code style="display:block;padding:8px 12px;margin:6px 0;font-size:13px;">FTV22050040<span style="background:#BFDE05;border-radius:3px;padding:0 2px;font-weight:700">2</span>R2C<span style="background:#BFDE05;border-radius:3px;padding:0 2px;font-weight:700">RAL7022</span></code>
          <span style="color:var(--grey)">Матовый (код «2» на позиции цвета) + суффикс RAL</span>
        </div>
      </div>
      <div>
